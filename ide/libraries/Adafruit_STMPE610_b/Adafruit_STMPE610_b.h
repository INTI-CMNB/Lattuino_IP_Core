...
// Configuration
// For SPI: select the mode SPI_MODE0 or SPI_MODE1
// Note: there is no point in autodecting it.
//       SDAT and A0 pins determine it
#define STMPE_SPI_MODE    SPI_MODE1
#define STMPE_ENABLE_HSPI 1
#define STMPE_ENABLE_SSPI 0
#define STMPE_ENABLE_I2C  0

#if STMPE_ENABLE_HSPI || STMPE_ENABLE_SSPI
  #define STMPE_ENABLE_SPI   1
#else
  #define STMPE_ENABLE_SPI   0
#endif
